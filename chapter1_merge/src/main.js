...
const COLORS = ['yellow', 'red', 'blue']; // 0: yellow, 1: red, 2: blue
...
class MergeGame extends Phaser.Scene {
    ...
    create() {
        ...
        for (let y = 0; y < GRID_SIZE; y++) {
            ...
            for (let x = 0; x < GRID_SIZE; x++) {
                ...
                this.grid[y][x] = { shape, color: 'yellow' };
                this.sprites[y][x] = this.drawShape(x, y, shape, 'yellow');
            }
        }
    ...
    addRandomGreenShape() {
        ...
        let {x, y} = empty[idx];
        this.grid[y][x] = { shape: randomShape(), color: 'yellow' };
    }
