// Spelling.js - Main scene for anatomy spelling game (chapter013_spelling)
class Spelling extends Phaser.Scene {
    ...
    showEndPopup() {
        const bullets = [
            'Great job exploring horse limb and muscle anatomy!',
            'Each structure plays a key role in movement and support.',
            'Can you spell them all again without hints?',
            'How do these parts help the horse in daily life?'
        ];
    ...
    create() {
        // List of all possible word objects (with name, prompt, answer, pronunciations)
        const allWords = [
            {
                name: 'Lateral cartilages',
                prompt: 'Spell the structures on the sides of the horse hoof that provide flexibility.',
                answer: 'Lateral cartilages',
                pronunciations: []
            },
            {
                name: 'Laminae',
                prompt: 'Spell the sensitive leaf-like structures inside the hoof.',
                answer: 'Laminae',
                pronunciations: ['LAM-uh-nee']
            },
            {
                name: 'Navicula Bone',
                prompt: 'Spell the small bone in the hoof that helps with movement.',
                answer: 'Navicula Bone',
                pronunciations: ['nuh-VIK-yuh-luh']
            },
            {
                name: 'Scapula',
                prompt: 'Spell the shoulder blade bone.',
                answer: 'Scapula',
                pronunciations: ['SKAP-yuh-luh']
            },
            {
                name: 'Carpus',
                prompt: 'Spell the equivalent of the horse’s knee (wrist).',
                answer: 'Carpus',
                pronunciations: ['KAR-pus']
            },
            {
                name: 'Gluteal',
                prompt: 'Spell the large muscle group in the horse’s hindquarters.',
                answer: 'Gluteal',
                pronunciations: ['GLOO-tee-ul']
            },
            {
                name: 'Humerus',
                prompt: 'Spell the upper arm bone.',
                answer: 'Humerus',
                pronunciations: ['HYOO-muh-rus']
            },
            {
                name: 'Hamstring',
                prompt: 'Spell the muscle group at the back of the thigh.',
                answer: 'Hamstring',
                pronunciations: []
            }
        ];
        // Randomly pick 3 unique word objects
        ...
        // Match chapter014_spelling: display word card near the top
        ...
        this.add.text(this.scale.width/2, 40, 'Anatomy Spelling Game', { font: '28px Arial', color: '#222' }).setOrigin(0.5);
        ...
        // Move feedback text further down to avoid overlap with letter buttons
