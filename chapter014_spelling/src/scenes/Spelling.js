// Spelling.js - Main scene for anatomy spelling game
class Spelling extends Phaser.Scene {
    ...
    showEndPopup() {
        const bullets = [
            'Great job exploring horse head and jaw anatomy!',
            'Each structure plays a key role in chewing, vision, and movement.',
        ...
        const allWords = [
            {
                ...
                prompt: 'Spell the joint that connects the jawbone to the skull.',
                answer: 'Temporomandibular joint',
                pronunciations: ['tem-puh-roh-man-DIB-yuh-ler']
            },
            {
                name: 'Masseter muscle',
                prompt: 'Spell the main muscle used for chewing.',
                answer: 'Masseter muscle',
                pronunciations: ['MAS-uh-ter']
            },
            {
                name: 'Pterygoid muscles',
                prompt: 'Spell the muscles that help move the jaw side to side.',
                answer: 'Pterygoid muscles',
                pronunciations: ['TER-uh-goyd']
            },
            {
                name: 'Mandible',
                prompt: 'Spell the lower jawbone.',
                answer: 'Mandible',
                pronunciations: ['MAN-duh-bul']
            },
            {
                name: 'Large lateral eyes',
                prompt: 'Spell the feature that gives horses a wide field of vision.',
                answer: 'Large lateral eyes',
                pronunciations: []
            },
            {
                name: 'Wide monocular fields',
                prompt: 'Spell the type of vision field that is wide and seen with one eye.',
                answer: 'Wide monocular fields',
                pronunciations: []
            },
            {
                name: 'Narrow binocular zone',
                prompt: 'Spell the vision zone where both eyes overlap.',
                answer: 'Narrow binocular zone',
                pronunciations: []
            }
        ];
