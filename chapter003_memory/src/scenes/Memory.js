...
class Memory extends Phaser.Scene {
    ...
    showCongratsPopup() {
        ...
        // Congratulation text
        const congratsText = this.add.text(popupX, popupY - 110, 'Congratulations! You matched all pairs!', { font: '18px Arial', color: '#388e3c', align: 'center', wordWrap: { width: popupWidth - 40 } }).setOrigin(0.5);
        // Bullet points
        const bullets = [
